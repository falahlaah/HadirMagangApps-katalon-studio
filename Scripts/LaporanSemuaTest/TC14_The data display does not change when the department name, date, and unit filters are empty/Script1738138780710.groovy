...
WebUI.waitForElementVisible(findTestObject('LaporanSemuaPage/filter section/btn_Terapkan'), 2)

WebUI.click(findTestObject('LaporanSemuaPage/filter section/btn_Terapkan'))

String beforetxtSumdata = WebUI.getText(findTestObject('LaporanSemuaPage/Table Section/txtSumData'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1)

WebUI.click(findTestObject('LaporanSemuaPage/btn_search'))

WebUI.verifyElementText(findTestObject('LaporanSemuaPage/Table Section/txtSumData'), beforetxtSumdata)
